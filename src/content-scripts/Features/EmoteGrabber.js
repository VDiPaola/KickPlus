...
import { BROWSER } from "../classes/Helpers";
...
export class EmoteGrabber{
    ...
    static off(){
        ...
        BROWSER.runtime.onMessage.removeListener(this.#handleOnMessage);
        this.#isOn = false;
    }
    ...
    static on(){
        ...
        BROWSER.runtime.onMessage.addListener(this.#handleOnMessage);
        this.#isOn = true;
    }
